...
1. Der Unterschied zwischen Texteditoren und Textprozessoren für die Code-Entwicklung kann erklärt und geeignete Editoren wie VS Code für die OER-Entwicklung ausgewählt werden.
<!-- competency: Orientierungswissen | bloom: 2 Verstehen -->
<!-- END: Technologie -->
```
...
1. Kenntnis, Auswahl und Nutzung verschiedener möglicher Dateiformate und Programmiersprachen
<!-- competency: Orientierungswissen | bloom: 3 Anwenden -->

2. Kenntnis, Auswahl und Nutzung spezifischer Auszeichungs- und Formatierungsoptionen
<!-- competency: Orientierungswissen | bloom: 3 Anwenden -->
...
1. Verständnis des Assessmentkonzepts von QUADRIGA.
<!-- competency: Orientierungswissen | bloom: 2 Verstehen -->

2. Auswahl und Implementierung spezifischer Assessment-Formate
<!-- competency: Orientierungswissen | bloom: 3 Anwenden -->
