...
the published GitHub Pages site under `_static/h5p/`.
...
```text
_build/html/_static/h5p/my-activity/index.html
```
...
5. Copy `_static/h5p/_template/index.html` into the activity folder.
